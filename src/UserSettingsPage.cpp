...
QStringList themes{
  ...
  QStringLiteral("everforest"),
  QStringLiteral("rose-pine"),
  QStringLiteral("rose-pine-moon"),
  QStringLiteral("kanagawa"),
  QStringLiteral("material-oceanic"),
  QStringLiteral("material-darker"),
  QStringLiteral("molokai-dim"),
  QStringLiteral("monokai"),
  QStringLiteral("one-dark"),
  QStringLiteral("github-dark"),
  QStringLiteral("ayu-dark-variant"),
  QStringLiteral("ayu-mirage-variant"),
  QStringLiteral("nightfox"),
  QStringLiteral("oxocarbon-oled"),
  QStringLiteral("oxocarbon"),
  QStringLiteral("oled"),
  QStringLiteral("carbon"),
  QStringLiteral("dim"),
  QStringLiteral("slate"),
  QStringLiteral("ember"),
  QStringLiteral("deep-sea"),
  QStringLiteral("plum"),
};
